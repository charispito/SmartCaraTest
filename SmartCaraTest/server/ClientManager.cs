        ...
        private async void asyncReadAsync(object obj)
        {
            ...
            while (clientdata.Run)
            {
                try
                {
                    ...
                    Console.WriteLine("ALL: {0}, Length: {1} Data: {2}", clientdata.readCompleteData.Count, result, byteToString(slice));
                    if (result > 0)
                    {
                        if (clientdata.readCompleteData.Count == 0)
                        {
                            if (clientdata.channel.IsNewVersion)
                            {
                                if (slice[0] != 0x12)
                                {
                                    Console.WriteLine("Head Error {0}", byteToString(slice));
                                }
                                else
                                {
                                    ...
                                    if (slice.Last() == 0x34)
                                    {
                                        ...
                                        {
                                            //완료
                                            Console.WriteLine("complete1: {0}", byteToString(clientdata.readCompleteData.ToArray()));
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (slice.Last() == 0xEF)
                                    {
                                        ...
                                        {
                                            //완료
                                            Console.WriteLine("complete2: {0}", byteToString(clientdata.readCompleteData.ToArray()));
                                            clientdata.channel.Dispatcher.Invoke(new Action(() => {
                                                switch (clientdata.readCompleteData[2])
                                                {
                                                    case 0xAA:
                        ...
                        else
                        {
                            if (clientdata.channel.IsNewVersion)
                            {
                                ...
                                {
                                    Console.WriteLine("Head Error: {0}", byteToString(clientdata.readCompleteData.ToArray()));
                                    clientdata.readCompleteData.Clear();
                                }
                                else
                                {
                                    ...
                                    if (clientdata.readCompleteData.Count > 3 && clientdata.readCompleteData[3] == clientdata.readCompleteData.Count)
                                    {
                                        ...
                                        {
                                            //완료
                                            Console.WriteLine("complete3: {0}", byteToString(clientdata.readCompleteData.ToArray()));
                                            clientdata.channel.Dispatcher.Invoke(new Action(() => {
                                                switch (clientdata.readCompleteData[2])
                                                {
                                                    case 0xAA:
                                        ...
                                        {
                                            Console.WriteLine("Error: {0}", byteToString(clientdata.readCompleteData.ToArray()));
                                            clientdata.readCompleteData.Clear();
                                        }
                                    }
                                    else
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (clientdata.readCompleteData.Count > 3 && clientdata.readCompleteData[3] == clientdata.readCompleteData.Count)
                                    {
                                        ...
                                        {
                                            //완료
                                            Console.WriteLine("complete4: {0}", byteToString(clientdata.readCompleteData.ToArray()));
                                            clientdata.channel.Dispatcher.Invoke(new Action(() => {
                                                switch (clientdata.readCompleteData[2])
                                                {
                                                    case 0xAA:
